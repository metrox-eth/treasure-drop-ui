      ...
      <div className='main-content'>
        ...
        <div className='content'>
          ...
          <div className="flex flex-row flex-wrap bg-white text-black mint-wrapper  border-8 border-t-0 border-black">
            <div className="basis-full md:basis-1/2 border-r-0 md:border-r-8 border-black">
              <div className='flex flex-row'>
                <div className="basis-1/2 md:basis-full border-r-4 border-b-8 border-black">
                  <div className="m-2">
                    <img src={artifactIcon} alt="artifactIcon" className='w-48 mx-auto my-12 '/>
                  </div>
                </div>
                <div className="basis-1/2 md:basis-full border-b-8 border-l-4 border-black">
                  <div className='border-b-8 border-black'>
                    <a href="https://snapshot.org/#/pistachiodao.eth"><img src={snapshotLogo} alt="artifactIcon" className='w-12 max-w-xs mx-auto my-12'/></a>
                  </div>
                  <div className='flex flex-row'>
                    <div className='basis-1/2 border-r-4 border-black'>
                      <a href="https://discord.snapshot.org/"><img src={discordIcon} alt="artifactIcon" className='w-12 max-w-xs mx-auto my-12'/></a>
                    </div>
                    <div className='basis-1/2 border-l-4 border-black'>
                      <a href="https://twitter.com/snapshotLabs"><img src={twitterIcon} alt="artifactIcon" className='w-12 max-w-xs mx-auto my-12'/></a>
                    </div>
                  </div>
                </div>
              </div>
              <div className='relative'>
                <h1 className='mt-20 text-xl'>ENTER YOUR CODE TO MINT</h1>
                ...
                <div>
                  <button className={`p-3 w-full mt-20 bg-black text-slate-50 hover:text-lime-500 ${!correctNetwork ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <div className="basis-full md:basis-1/2 bg-slate-50 nft-icon border-b-8 border-8 md:border-0 border-black">
              {/* <img src={nftIcon} alt="nftIcon" className='w-full'/> */}
            </div>
          </div>
